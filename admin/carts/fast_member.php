...
<td width="95%"><a href="//www.idevlibrary.com/files/idevaffiliate-fastmember.zip" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
...
<td width="95%"><img src="//www.idevlibrary.com/files/fm_plugin.png" style="width:727px; height:76px; border:none;" /></td>
</tr>
<tr>
<td width="5%" align="center">3.</td>
<td width="95%">In WordPress, go to <strong><?PHP echo $cart_name; ?></strong> -> <strong>iDevAffiliate</strong>.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="//www.idevlibrary.com/files/fm_settings.png" style="width:799px; height:237px; border:none;" /></td>
</tr>
</table>
</div>
</div>
