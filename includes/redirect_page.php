<?PHP
if (!defined('IDEV_FILE_AUTH')) { die('redirect_page.php - Unauthorized Access'); }
...
// Offline Location Page
// ------------------------------------
} elseif (isset($_REQUEST['offline_delivery'])) {
...
if ($sendgeo != '') { $redirect = $sendgeo; }
}

// Default Page
// ------------------------------------
if ((!isset($redirect)) || ($redirect == '') || ($redirect == 'http://')) { $redirect = $default_destination; }
